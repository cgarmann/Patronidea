  ...
  ideas: [
    {
      ...
      category: "Healthtech",
      innovatorBackground: "Nurse",
      tags: ["B2B", "Workflow", "Training"],
      status: "active",
      maturity: "Prototype-ready",
      requestState: "open",
      validationState: "Operational pain confirmed",
      confidence: "High",
    ...
    },
    {
      ...
      category: "Energy",
      innovatorBackground: "Engineer",
      tags: ["B2B", "Procurement", "Benchmarking"],
      status: "active",
      maturity: "Validated concept",
      requestState: "deal room ready",
      validationState: "Market benchmarked",
    ...
    },
    {
      ...
      category: "Operations",
      innovatorBackground: "Finance",
      tags: ["SMB", "Risk", "Finance"],
      status: "active",
      maturity: "MVP-specified",
      requestState: "open",
      validationState: "Workflow mapped",
      confidence: "High",
    ...
    },
    {
      ...
      requestState: "open",
      validationState: "Technical brief complete",
      confidence: "Medium",
